#!/usr/bin/env python3
"""Build the dependency-free MM Trading Bot Logs static site."""
...
PROJECT_GITHUB_REPOS = {'eth-wallet-generator': 'Virae-Labs/eth-wallet-generator', 'trading-bot': 'Virae-Labs/trading-bot', 'trading-bot-dashboard': 'Virae-Labs/trading-bot-dashboard'}
...
def build(reports: list[Report]) -> None:
  ...
  <p class="eyebrow">MM Trading Bot · Daily change log</p>
  </div></header>
...
<footer class="site-footer"><div class="shell">从真实代码变动中提炼 · Asia/Shanghai</div></footer>"""
        (target / "index.html").write_text(
            page(report.title, detail_body, description=f"MM Trading Bot {report.day} 项目变动总结", depth=2),
            encoding="utf-8",
        )
...
<aside class="sidebar">
  <header class="site-header">
    ...
    <h1 class="site-title">MM Trading Bot Logs</h1>
    <p class="site-intro">把分散在前端、后端与钱包工具 的代码变化，整理成使用者真正能感知的功能更新。</p>
  ...
  <p class="update-note">每日 20:00 北京时间更新</p>
</aside>
...
<footer class="site-footer"><div class="shell">MM Trading Bot 项目变动总结 · 由 Codex 自动整理</div></footer>
<script src="assets/app.js" defer></script>"""
    (OUTPUT / "index.html").write_text(
        page("MM Trading Bot Logs", index_body, description="MM Trading Bot 每日产品与技术变动日志"),
        encoding="utf-8",
    )
